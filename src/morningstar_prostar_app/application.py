...
from .app_state import MorningstarProstarAppState
...
class MorningstarProstarAppApplication(Application):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.state: MorningstarProstarAppState = None

    async def setup(self):
        self.ui = MorningstarProstarAppUI()
        self.state = MorningstarProstarAppState()
